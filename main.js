...
//   console.log(customers.customers[0].contacts.email)
  ...
  const objFilter = customers.customers.map(function(person){
console.log(person)
return person.contacts.email;
  })

  console.log(objFilter)
  const custEmails = objFilter
  const joinEmails = custEmails.join(" ")
  console.log(joinEmails)
  console.log(objFilter);
  let noCommas ="";
 objFilter.forEach(function(contacts){
noCommas = joinEmails.replace(","," ")
return noCommas;
 })
